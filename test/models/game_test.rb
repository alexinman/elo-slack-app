  ...
  context 'GameTest' do
    ...
    context '#for_slack_user_id' do
      context 'singles' do
        setup do
          ...
          @game = FactoryBot.create(:game, :draw, player_one: @player1, player_two: @player2)

          player3 = FactoryBot.create(:player3, game_type: @game_type)
          player4 = FactoryBot.create(:player4, game_type: @game_type)
          FactoryBot.create(:game, :draw, player_one: player3, player_two: player4)
        end
    ...
    context '#result_for' do
      ...
      context 'player_one wins' do
        setup do
          @game = FactoryBot.create(:game, :player_one_wins, player_one: @player1, player_two: @player2)
        end
      ...
      context 'player_one loses' do
        setup do
          @game = FactoryBot.create(:game, :player_one_loses, player_one: @player1, player_two: @player2)
        end
