...
class PlayerTest < ActiveSupport::TestCase
  context 'PlayerTest' do
        ...
        context 'with game' do
          context 'win' do
            ...
            context 'player_two' do
              setup do
                @game = FactoryBot.create(:game, player_one_id: @player2.id, player_two_id: @player1.id, result: 0)
              end
          ...
          context 'loss' do
            context 'player_one' do
              setup do
                @game = FactoryBot.create(:game, player_one_id: @player1.id, player_two_id: @player2.id, result: 0)
              end
            ...
            context 'player_two' do
              setup do
                @game = FactoryBot.create(:game, player_one_id: @player2.id, player_two_id: @player1.id, result: 1)
              end
          ...
          context 'tie' do
            context 'player_one' do
              setup do
                @game = FactoryBot.create(:game, player_one_id: @player1.id, player_two_id: @player2.id, result: 0.5)
              end
            ...
            context 'player_two' do
              setup do
                @game = FactoryBot.create(:game, player_one_id: @player2.id, player_two_id: @player1.id, result: 0.5)
              end
    ...
    context '#elo_player' do
      ...
      context 'existing Player' do
        ...
        context 'with games' do
          setup do
            player2 = FactoryBot.create(:player2, game_type: @game_type)
            FactoryBot.create(:game, player_one_id: @player.id, player_two_id: player2.id, result: 1)
            FactoryBot.create(:game, player_one_id: player2.id, player_two_id: @player.id, result: 1)
            FactoryBot.create(:game, player_one_id: @player.id, player_two_id: player2.id, result: 0)
            FactoryBot.create(:game, player_one_id: player2.id, player_two_id: @player.id, result: 0)
            FactoryBot.create(:game, player_one_id: @player.id, player_two_id: player2.id, result: 0.5)
            FactoryBot.create(:game, player_one_id: player2.id, player_two_id: @player.id, result: 0.5)

            player3 = FactoryBot.create(:player3, game_type: @game_type)
            FactoryBot.create(:game, player_one_id: player3.id, player_two_id: player2.id, result: 1)
            FactoryBot.create(:game, player_one_id: player2.id, player_two_id: player3.id, result: 1)
            FactoryBot.create(:game, player_one_id: player3.id, player_two_id: player2.id, result: 0)
            FactoryBot.create(:game, player_one_id: player2.id, player_two_id: player3.id, result: 0)
            FactoryBot.create(:game, player_one_id: player3.id, player_two_id: player2.id, result: 0.5)
            FactoryBot.create(:game, player_one_id: player2.id, player_two_id: player3.id, result: 0.5)
          end
    ...
    context '#team_tag' do
      ...
      context 'triples' do
        setup do
          @player = FactoryBot.create(:player, game_type: @game_type, slack_user_id: '@PLAYER1-@PLAYER2-@PLAYER3', team_size: 3)
        end
    ...
    context '#number_of_wins' do
      ...
      context 'with game' do
        context 'as player_one' do
          ...
          context 'win' do
            setup do
              @game = FactoryBot.create(:game, result: 1, player_one_id: @player1.id, player_two_id: @player2.id)
            end
          ...
          context 'loss' do
            setup do
              @game = FactoryBot.create(:game, result: 0, player_one_id: @player1.id, player_two_id: @player2.id)
            end
          ...
          context 'draw' do
            setup do
              @game = FactoryBot.create(:game, result: 0.5, player_one_id: @player1.id, player_two_id: @player2.id)
            end
    ...
    context '#nemesis' do
      [1, 2].each do |team_size|
        context "team_size:#{team_size}" do
            ...
            context "as player #{player_num_v_p2}" do
              ...
              [0, 2, 4, 5].repeated_permutation(2).each do |wins_v_p2, losses_v_p2|
                context "#{wins_v_p2}-#{losses_v_p2} v p2" do
                  setup do
                    wins_v_p2.times { FactoryBot.create(:game, player_one_id: @player1_v_p2.id, player_two_id: @player2_v_p2.id, result: player_num_v_p2 == 1 ? 1 : 0) }
                    losses_v_p2.times { FactoryBot.create(:game, player_one_id: @player1_v_p2.id, player_two_id: @player2_v_p2.id, result: player_num_v_p2 == 1 ? 0 : 1) }
                  end
                    ...
                    context "as player #{player_num_v_p3}" do
                      ...
                      [0, 1, 3, 5].repeated_permutation(2).each do |wins_v_p3, losses_v_p3|
                        context "#{wins_v_p3}-#{losses_v_p3} v p3" do
                          setup do
                            wins_v_p3.times { FactoryBot.create(:game, player_one_id: @player1_v_p3.id, player_two_id: @player2_v_p3.id, result: player_num_v_p3 == 1 ? 1 : 0) }
                            losses_v_p3.times { FactoryBot.create(:game, player_one_id: @player1_v_p3.id, player_two_id: @player2_v_p3.id, result: player_num_v_p3 == 1 ? 0 : 1) }
                          end
          ...
          context '4 losses against P2, 5 losses against P3' do
            setup do
              4.times { FactoryBot.create(:game, :player_one_loses, player_one: @player, player_two: @player2) }
              5.times { FactoryBot.create(:game, :player_one_loses, player_one: @player, player_two: @player3) }
            end
      ...
      context 'doubles_individual' do
        setup do
          ...
          @p1p2 = FactoryBot.create(:player, :doubles, game_type: @game_type, slack_user_id: "#{@p1_slack_user_id}-#{@p2_slack_user_id}")
          @p1p3 = FactoryBot.create(:player, :doubles, game_type: @game_type, slack_user_id: "#{@p1_slack_user_id}-#{@p3_slack_user_id}")
          @p1p4 = FactoryBot.create(:player, :doubles, game_type: @game_type, slack_user_id: "#{@p1_slack_user_id}-#{@p4_slack_user_id}")
          @p2p3 = FactoryBot.create(:player, :doubles, game_type: @game_type, slack_user_id: "#{@p2_slack_user_id}-#{@p3_slack_user_id}")
          @p2p4 = FactoryBot.create(:player, :doubles, game_type: @game_type, slack_user_id: "#{@p2_slack_user_id}-#{@p4_slack_user_id}")
          @p3p4 = FactoryBot.create(:player, :doubles, game_type: @game_type, slack_user_id: "#{@p3_slack_user_id}-#{@p4_slack_user_id}")
        ...
        context '1 loss against P2' do
          context 'on T1' do
            setup do
              FactoryBot.create(:game, :player_one_loses, player_one: @p1p3, player_two: @p2p4)
            end
          ...
          context 'on T2' do
            setup do
              FactoryBot.create(:game, :player_one_wins, player_one: @p2p4, player_two: @p1p3)
            end
          ...
          context 'on T1' do
            setup do
              4.times do |i|
                ...
                FactoryBot.create(:game, :player_one_loses, player_one: team1, player_two: team2)
              end
            end
        ...
        context '5 losses against P2, 5 losses against P3, 6 losses against P4' do
          setup do
            FactoryBot.create(:game, :player_one_loses, player_one: @p1p2, player_two: @p3p4)
            FactoryBot.create(:game, :player_one_loses, player_one: @p1p2, player_two: @p3p4)
            FactoryBot.create(:game, :player_one_loses, player_one: @p1p2, player_two: @p3p4)
            FactoryBot.create(:game, :player_one_loses, player_one: @p1p3, player_two: @p2p4)
            FactoryBot.create(:game, :player_one_loses, player_one: @p1p3, player_two: @p2p4)
            FactoryBot.create(:game, :player_one_loses, player_one: @p1p3, player_two: @p2p4)
            FactoryBot.create(:game, :player_one_loses, player_one: @p1p4, player_two: @p2p3)
            FactoryBot.create(:game, :player_one_loses, player_one: @p1p4, player_two: @p2p3)
          end
        ...
        context '2-3 against P2, 4-3 against P3, 6-6 against P4' do
          setup do
            ...
            FactoryBot.create(:game, :player_one_loses, player_one: @p1p3, player_two: @p2p4)
            FactoryBot.create(:game, :player_one_loses, player_one: @p1p3, player_two: @p2p4)
            FactoryBot.create(:game, :player_one_wins, player_one: @p1p3, player_two: @p2p4)
            FactoryBot.create(:game, :player_one_wins, player_one: @p1p3, player_two: @p2p4)

            FactoryBot.create(:game, :player_one_loses, player_one: @p1p2, player_two: @p3p4)
            FactoryBot.create(:game, :player_one_loses, player_one: @p1p2, player_two: @p3p4)
            FactoryBot.create(:game, :player_one_loses, player_one: @p1p2, player_two: @p3p4)
            FactoryBot.create(:game, :player_one_wins, player_one: @p1p2, player_two: @p3p4)
            FactoryBot.create(:game, :player_one_wins, player_one: @p1p2, player_two: @p3p4)
            FactoryBot.create(:game, :player_one_wins, player_one: @p1p2, player_two: @p3p4)
            FactoryBot.create(:game, :player_one_wins, player_one: @p1p2, player_two: @p3p4)
          end
