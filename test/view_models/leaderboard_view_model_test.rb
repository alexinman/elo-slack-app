...
class LeaderboardViewModelTest < ActiveSupport::TestCase
  context 'LeaderboardViewModelTest' do
    ...
    context '#leaderboard' do
      [0, 1, 5, 10, 20].each do |num_singles|
        context "num_singles:#{num_singles.inspect}" do
          setup do
            reset_ratings
            @singles = num_singles.times.map { FactoryBot.create(:player, :with_slack_team_id, :singles, :with_singles_user_id, game_type: @game_type, rating: rating) }.sort_by { |p| [p.rating, p.id] }.reverse
          end
          ...
          [0, 1, 5, 10, 20].each do |num_doubles|
            context "num_doubles:#{num_doubles.inspect}" do
              setup do
                reset_ratings
                @doubles = num_doubles.times.map { FactoryBot.create(:player, :with_slack_team_id, :doubles, :with_doubles_user_id, game_type: @game_type, rating: rating) }.sort_by { |p| [p.rating, p.id] }.reverse
              end
      ...
      context 'single player' do
        setup do
          @player = FactoryBot.create(:player, :with_slack_team_id, :singles, :with_singles_user_id, game_type: @game_type, rating: 1000)
        end
    ...
    context '#surrounding_ranks' do
      setup do
        @player1 = FactoryBot.create(:player, :with_slack_team_id, :singles, :with_singles_user_id, game_type: @game_type, rating: 1000)#1
        @player2 = FactoryBot.create(:player, :with_slack_team_id, :singles, :with_singles_user_id, game_type: @game_type, rating: 999)#2
        @player3 = FactoryBot.create(:player, :with_slack_team_id, :singles, :with_singles_user_id, game_type: @game_type, rating: 998)#3
        @player4 = FactoryBot.create(:player, :with_slack_team_id, :singles, :with_singles_user_id, game_type: @game_type, rating: 998)#4
        @player5 = FactoryBot.create(:player, :with_slack_team_id, :singles, :with_singles_user_id, game_type: @game_type, rating: 998)#5
        @player6 = FactoryBot.create(:player, :with_slack_team_id, :singles, :with_singles_user_id, game_type: @game_type, rating: 998)#6
        @player7 = FactoryBot.create(:player, :with_slack_team_id, :singles, :with_singles_user_id, game_type: @game_type, rating: 998)#7
        @player8 = FactoryBot.create(:player, :with_slack_team_id, :singles, :with_singles_user_id, game_type: @game_type, rating: 997)#8
        @player9 = FactoryBot.create(:player, :with_slack_team_id, :singles, :with_singles_user_id, game_type: @game_type, rating: 996)#9
      end
