  ...
  context 'PlayerViewModelTest' do
    ...
    context '#list' do
      ...
      context 'optional_parameter:game_type_id' do
        setup do
          ...
          other_game_type = FactoryBot.create(:game_type, :with_slack_team_id)
    ...
    context '#statistics' do
      setup do
        ...
        @dp2_gt1 = FactoryBot.create(:player, :doubles, :with_slack_team_id, slack_user_id: '@PLAYER1-@PLAYER3', game_type: @game_type1, rating: 400)
        @dp2_gt2 = FactoryBot.create(:player, :doubles, :with_slack_team_id, slack_user_id: '@PLAYER1-@PLAYER3', game_type: @game_type2, rating: 410)
